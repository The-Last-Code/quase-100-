...
<?php
    ...
    class PerfilModel extends Conn
    {
        ...
        {   
            $sqlSelect = $this->pdo->query("SELECT projeto.tit_projeto, projeto.dti_projeto, projeto.dtt_projeto, projeto.res_projeto, projeto.id_projeto,cientista.nom_cientista, cientista.email_cientista
            FROM projeto 
            INNER JOIN cientista on projeto.fk_id_cientista=cientista.id_cientista 
            WHERE fk_id_cientista = $id AND id_cientista = $id");
        ...
        {
            $sqlSelect = $this->pdo->query("SELECT cientista.nom_cientista,cientista.email_cientista,telefone.ddd_telefone,telefone.num_telefone,telefone.fk_id_cientista,formacao.dti_formacao,formacao.dtt_formacao,
            rede_sociais.end_rede_social
            from cientista
